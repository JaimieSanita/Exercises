...
--GNP MUST BE OFF, ROWS DON'T MATCH

SELECT name, continent, GNP, lifeexpectancy FROM country WHERE lifeexpectancy >= 70 AND GNP <= 100 AND GNP >= 1;
-- 21. The per capita GNP (i.e. GNP divided by population) in US Dollars of all countries in Europe (46 rows)

SELECT gnp / population AS "Population Per Area"
FROM country 
