...
public class Exercises {
	...
	public String makeOutWord(String out, String word) {
		...
		String makeWord = (frontOut + word + backOut);
		return makeWord;
	}
	...
	public String extraEnd(String str) {
		String lastTwo = (str.substring(str.length() - 2) + str.substring(str.length() - 2)
	...
	public String firstHalf(String str) {
		String strLength = str.substring(0, str.length() / 2);
		return strLength;
	}
	...
	public String comboString(String a, String b) {
		String aLessThanB = (a + b + a);
		String bLessThanA = (b + a + b);
	...
	public String nonStart(String a, String b) {
		String togetherNoFirst = a.substring(1) + b.substring(1);
		return togetherNoFirst;
	}
	...
	public String left2(String str) {
		String extractFirstTwo = str.substring(0, 2);
		String addFirstToEnd = str.substring(2) + extractFirstTwo;
		return addFirstToEnd;
	}
	...
	public String right2(String str) {
		String extractLastTwo = str.substring(str.length() - 2);
		String addLastToFront = extractLastTwo + str.substring(0, 3);
		return addLastToFront;
	}
	...
	public String withoutEnd2(String str) {
				if (str.length() > 2) {
			String noFirstAndLast = str.substring(1, str.length()-1);
	...
	public String middleTwo(String str) {
		String half = str.substring(str.length()/2-1, str.length()/2+1);
		return half;
	}
	...
	public boolean endsLy(String str) {
		boolean endsLy = str.endsWith("ly");
		if (endsLy) {
			return true;
		}
		return false;
	...
	public String nTwice(String str, int n) {
		String nFirstNLast = str.substring(0, n) + str.substring(str.length() - n);		
		return nFirstNLast;
	...
	public String twoChar(String str, int index) {
		...
		if (index >=0 && index <= str.length()-2) {
			String lengthTwo = str.substring(index, index+2);
			return lengthTwo;
		} else {
		return firstTwo;
	}
	...
	public String middleThree(String str) {
		String halfString = str.substring((str.length() / 2 -1), (str.length() / 2 + 2));
