    ...
    <div class="well-display">
      ...
      <div class="well">
        ...
        5 Star Review{{ numberOfFiveStarReviews === 1 ? '' : 's' }}
                           ...
                           <!-- declaring showForm method and setting equal to true --> <!-- hides Show Form button if method equal to false-->
    <a id="show-form-button" href="#" v-on:click.prevent="showForm = true"                        v-if="showForm===false"> ShowForm </a>
