      ...
      reviews: [
        {
          ...
          title: 'What a Book!',
          review: 'It certainly is a book. I mean, I can see that. Pages kept together with glue and theres writing on it.',
          rating: 3,
          isFavorite: false,
        },
        {
          reviewer: 'Jaimie Sanita',
          title: 'Book!',
          review: 'Boring',
          rating: 2,
          isFavorite: false,
  ...
  computed: {
    averageRating() {
      ...
      const totalRating = reviewArr.reduce((currentTotal, review) => {
        return currentTotal + review.rating; }, 0);
      return totalRating / reviewArr.length;
    },
    numberOfOneStarReviews() {
      return this.reviews.reduce((num, review) => { if (review.rating === 1) {
              return num + 1;
          } else {
              return num;
          } }, 0); },
